...
def create_url(keyword, start_date, end_date, max_results=10):
    ...
    query_params = {
        ...
        "tweet.fields": "created_at, likes.fields(public), retweet.fields(public)",
        "next_token": {},
    }
...
start_date = "2023-01-11T04:00:00.000Z"
end_date = "2023-01-11T06:35:00.000Z"
max_results = 200
total_tweets = 0
...
csvWriter.writerow(["created_at", "text", "author_id", "username"])
csvFile.close()
...
def append_to_csv(json_response, fileName):
    ...
    for i in range(len(json_response["data"])):
        ...
        res = [created_at, text, author_id, username]
